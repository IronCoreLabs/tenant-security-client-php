...
This directory contains some examples of using the PHP Tenant Security Client (TSC) SDK to protect sensitive data.
...
Once the TSP and LD are running, you can experiment with the example PHP programs. Each of the subdirectories contains
